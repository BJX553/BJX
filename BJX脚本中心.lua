...
background.BackgroundTransparency = 0.3  -- 70%透明
...
blurOverlay.BackgroundTransparency = 0.7  -- 更透明的模糊层
...
imageContainer.Position = UDim2.new(0.5, 0, 0.5, 0)
imageContainer.Size = UDim2.new(0, 280, 0, 280)
imageContainer.BackgroundColor3 = Color3.new(1, 1, 1)
imageContainer.BackgroundTransparency = 0.9  -- 几乎透明
imageContainer.Parent = gui

-- 添加圆角
local corner = Instance.new("UICorner")
corner.CornerRadius = UDim.new(0.2, 0)
corner.Parent = imageContainer

-- 加载图片 (带透明度)
local imageLabel = Instance.new("ImageLabel")
imageLabel.Size = UDim2.new(0.9, 0, 0.9, 0)
imageLabel.Position = UDim2.new(0.05, 0, 0.05, 0)
imageLabel.Image = "rbxassetid://135821322702589"
imageLabel.BackgroundTransparency = 1
imageLabel.ImageTransparency = 0.2  -- 图片轻微透明
...
textLabel.Position = UDim2.new(0.5, 0, 1.1, 10)
...
textLabel.TextTransparency = 0.4  -- 文本半透明
textLabel.TextStrokeTransparency = 0.8  -- 文本描边半透明
...
-- 动画函数
local function transparentAnimation()
    -- 初始淡入动画
    local fadeIn = TweenService:Create(
        imageContainer,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {BackgroundTransparency = 0.8}  -- 从90%透明变为80%透明
    )
    fadeIn:Play()
    ...
    local imageFadeIn = TweenService:Create(
        imageLabel,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {ImageTransparency = 0.05}  -- 从20%透明变为5%透明
    )
    imageFadeIn:Play()
    ...
    local textFadeIn = TweenService:Create(
        textLabel,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {TextTransparency = 0.2}  -- 从40%透明变为20%透明
    )
    textFadeIn:Play()
    ...
    local fadeOut = TweenService:Create(
        imageContainer,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {BackgroundTransparency = 1}  -- 变为完全透明
    )
    
    local imageFadeOut = TweenService:Create(
        imageLabel,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {ImageTransparency = 1}  -- 图片完全透明
    )
    
    local textFadeOut = TweenService:Create(
        textLabel,
        TweenInfo.new(0.8, Enum.EasingStyle.Quad),
        {TextTransparency = 1}  -- 文本完全透明
    )
...
library.prompt('北极星脚本中心下次更新提示', '8月日进行更新', 10)
