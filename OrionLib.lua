game:GetService("StarterGui"):SetCore("SendNotification", {Title = "BJX脚本中心UI";Text = "验证中……";Icon = "rbxassetid://118173114413379"})Duration = 8;
...
function OrionLib:MakeWindow(WindowConfig)
    ...
    WindowConfig.IntroToggleIcon = WindowConfig.IntroToggleIcon or "rbxassetid://118173114413379"
        WindowConfig.IntroText = WindowConfig.IntroText or "BJX脚本中心."
        WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
        WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
        WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://118173114413379"
        WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://118173114413379"
        ...
        local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
                ...
                SetChildren(SetProps(MakeElement("TFrame"), {
                        ...
                        AddThemeObject(SetProps(MakeElement("Label", "用户名字验证成功", 12), {
    ...
    local MobileReopenButton = SetChildren(SetProps(MakeElement("Button"), {
                ...
                AddThemeObject(SetProps(MakeElement("Image", WindowConfig.IntroToggleIcon or "http://www.roblox.com/asset/?id=118173114413379"), {
        ...
        AddConnection(CloseBtn.MouseButton1Up, function()
                ...
                UIHidden = true
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "BJX脚本中心";Text = "UI关闭成功";Icon = "rbxassetid://118173114413379"})Duration = 8;
    local sound = Instance.new("Sound", workspace)
sound.SoundId = "rbxassetid://6647898215"
sound:Play()
local sound = Instance.new("Sound", workspace)
